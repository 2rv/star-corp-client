...
export const RECOVERY_ACCOUNT_CONFIRM = {
  SUCCESS: 'RECOVERY_ACCOUNT_CONFIRM.SUCCESS',
  LOADING: 'RECOVERY_ACCOUNT_CONFIRM.LOADING',
  FAIL: 'RECOVERY_ACCOUNT_CONFIRM.FAIL',
  SET_DATA: 'RECOVERY_ACCOUNT_CONFIRM.SET_DATA',
};
